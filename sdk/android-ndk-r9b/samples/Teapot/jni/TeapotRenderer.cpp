...
void TeapotRenderer::init()
{
    ...
    updateViewport();
    _mModel = ndkHelper::mat4::translation(0, 0, -15.f);

    ndkHelper::mat4 mat = ndkHelper::mat4::rotationX(M_PI / 3);
    _mModel = mat * _mModel;
}
...
void TeapotRenderer::render()
{
    ...
    ndkHelper::mat4 mVP = _mProjection * _mView;
...
bool TeapotRenderer::bind(ndkHelper::tapCamera* camera)
{
    _camera = camera;
    return true;
}
