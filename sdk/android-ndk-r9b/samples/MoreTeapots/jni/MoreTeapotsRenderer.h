...
class MoreTeapotsRenderer
{
    ...
    ndkHelper::mat4 _mProjection;
    ndkHelper::mat4 _mView;
    std::vector<ndkHelper::mat4> _mModels;
    std::vector<ndkHelper::vec3> _mColors;
    std::vector<ndkHelper::vec2> _mVecRotation;
    std::vector<ndkHelper::vec2> _mCurrentRotation;

    ndkHelper::tapCamera* _camera;
...
public:
    ...
    bool bind(ndkHelper::tapCamera* camera);
    void unload();
    void updateViewport();
};
